...
def find_coins(image, iterator):
    """
    This function finds the coins in the image and returns the coordinates of the coins.  The function also returns the
    height, width and the area of the coins.
    :param image:
    :param iterator:
    :return:
    """
...
def find_tray(image, iterator):
    """
    This function finds the tray in the image and returns the coordinates of the tray.  The function also returns the
    height, width and the area of the tray.
    :param image:
    :param iterator:
    :return:
    """
...
def parse_arguments():
    parser = argparse.ArgumentParser(description='This script identifies the coins and tray dimensions with OpenCV.'
                                                 ' To run script you need to provide the path to the image as -i argument.'
                                                 ' If you want to select image, use -s')
    ...
    parser.add_argument('-s',
                        '--saw_image_to_identify',
                        type=str,
                        default=None,
                        help='Optional - saw image to identify, if not provided, script will take saw2.jpg')
